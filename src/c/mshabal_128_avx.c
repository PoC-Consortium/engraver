...
static void mshabal128_avx_compress(mshabal128_context *sc, const unsigned char *buf0,
...
void mshabal128_avx_init(mshabal128_context *sc, unsigned out_size) {
    ...
    mshabal128_avx_compress(sc, sc->buf0, sc->buf1, sc->buf2, sc->buf3, 1);
    for (u = 0; u < 16; u++) {
...
void mshabal128_avx(mshabal128_context *sc, const void *data0, const void *data1, const void *data2,
    ...
    num = len >> 6;
    if (num != 0) {
        mshabal128_avx_compress(sc, data0, data1, data2, data3, num);
...
/* see shabal_small.h */
void mshabal128_avx_close(mshabal128_context *sc, unsigned ub0, unsigned ub1, unsigned ub2, unsigned ub3,
