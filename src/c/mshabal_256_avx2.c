...
static void mshabal256_compress(mshabal256_context *sc, const unsigned char *buf0,
...
void mshabal256(mshabal256_context *sc, const void *data0, const void *data1, const void *data2,
    ...
    num = len >> 6;
    if (num != 0) {
        mshabal256_compress(sc, (const unsigned char *)data0, (const unsigned char *)data1,
...
/* see shabal_small.h */
void mshabal256_close(mshabal256_context *sc, unsigned ub0, unsigned ub1, unsigned ub2,
