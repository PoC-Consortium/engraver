...
typedef struct {
    ...
    size_t ptr;
    mshabal_u32 state[(12 + 16 + 16) * 4 * MSHABAL128_FACTOR];
 ...
 * in bits.
 */
void mshabal128_avx_init(mshabal128_context *sc, unsigned out_size);
 ...
 */
void mshabal128_avx(mshabal128_context *sc, const void *data0, const void *data1, const void *data2,
 ...
 */
void mshabal128_avx_close(mshabal128_context *sc, unsigned ub0, unsigned ub1, unsigned ub2,
                      unsigned ub3, unsigned n, void *dst0, void *dst1, void *dst2, void *dst3);
 ...
 */
void mshabal128_avx_openclose_fast(mshabal128_context_fast *sc, void *message, void *termination,
